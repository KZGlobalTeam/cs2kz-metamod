...
void KZPlayer::Reset()
{
	...
	g_pKZModeManager->SwitchToMode(this, KZOptionService::GetDefaultOptionStr("defaultMode", "CKZ"), true);
	g_pKZStyleManager->SwitchToStyle(this, KZOptionService::GetDefaultOptionStr("defaultStyle", "NRM"), true);
}
