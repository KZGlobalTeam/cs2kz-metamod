...
namespace sigs
{
	...
	// in that function.
	DECLARE_SIG(Cbpp_ProcessUsercmds, "\x48\x8B\xC4\x44\x88\x48\x20\x44\x89\x40\x18\x48\x89\x50\x10\x53");
#else
	...
	DECLARE_SIG(Cbpp_ProcessUsercmds, "\x55\x48\x89\xE5\x41\x57\x41\x56\x41\x89\xD6\x41\x55\x49\x89\xFD\x41\x54\x53");	
#endif
}