...
namespace sigs
{
	...
	DECLARE_SIG(CCSGameRules_ctor, "\x48\x8B\xC4\x48\x89\x48\x08\x55\x53\x56\x57\x41\x54\x41\x55\x41\x56\x41\x57\x48\x8D\xA8");
	...
	DECLARE_SIG(CCSGameRules_ctor, "\x55\x48\x89\xE5\x41\x57\x41\x56\x41\x55\x41\x54\x53\x48\x89\xFB\x4C\x8D\xA3\x2A\x2A\x2A\x2A\x48\x81");
