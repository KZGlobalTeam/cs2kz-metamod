...
PROTOBUF_CONSTEXPR CSGOInputHistoryEntryPB::CSGOInputHistoryEntryPB(
  ...
  , /*decltype(_impl_.buttonstate_)*/uint64_t{0u}
...
const uint32_t TableStruct_cs_5fusercmd_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::CSGOInputHistoryEntryPB, _impl_.buttonstate_),
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 12, 34, -1, sizeof(::CSGOInputHistoryEntryPB)},
  { 50, 61, -1, sizeof(::CSGOUserCmdPB)},
};
...
const char descriptor_table_protodef_cs_5fusercmd_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  " \001(\005:\002-1\022\017\n\004frac\030\003 \001(\002:\0010\"\327\004\n\027CSGOInputH"
  "istoryEntryPB\022\023\n\013buttonstate\030\001 \001(\004\022 \n\013vi"
  "ew_angles\030\002 \001(\0132\013.CMsgQAngle\022\031\n\021render_t"
  "ick_count\030\004 \001(\005\022\034\n\024render_tick_fraction\030"
  "\005 \001(\002\022\031\n\021player_tick_count\030\006 \001(\005\022\034\n\024play"
  "er_tick_fraction\030\007 \001(\002\022+\n\tcl_interp\030\014 \001("
  "\0132\030.CSGOInterpolationInfoPB\022,\n\nsv_interp"
  "0\030\r \001(\0132\030.CSGOInterpolationInfoPB\022,\n\nsv_"
  "interp1\030\016 \001(\0132\030.CSGOInterpolationInfoPB\022"
  "/\n\rplayer_interp\030\017 \001(\0132\030.CSGOInterpolati"
  "onInfoPB\022\024\n\014frame_number\030\024 \001(\005\022\034\n\020target"
  "_ent_index\030\010 \001(\005:\002-1\022#\n\016shoot_position\030\003"
  " \001(\0132\013.CMsgVector\022*\n\025target_head_pos_che"
  "ck\030\t \001(\0132\013.CMsgVector\022)\n\024target_abs_pos_"
  "check\030\n \001(\0132\013.CMsgVector\022)\n\024target_abs_a"
  "ng_check\030\013 \001(\0132\013.CMsgQAngle\"\332\001\n\rCSGOUser"
  "CmdPB\022\035\n\004base\030\001 \001(\0132\017.CBaseUserCmdPB\022/\n\r"
  "input_history\030\002 \003(\0132\030.CSGOInputHistoryEn"
  "tryPB\022\'\n\033attack1_start_history_index\030\006 \001"
  "(\005:\002-1\022\'\n\033attack2_start_history_index\030\007 "
  "\001(\005:\002-1\022\'\n\033attack3_start_history_index\030\010"
  " \001(\005:\002-1"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_cs_5fusercmd_2eproto = {
    false, false, 968, descriptor_table_protodef_cs_5fusercmd_2eproto,
    "cs_usercmd.proto",
...
class CSGOInputHistoryEntryPB::_Internal {
 public:
  ...
  static void set_has_buttonstate(HasBits* has_bits) {
    (*has_bits)[0] |= 512u;
  }
...
CSGOInputHistoryEntryPB::CSGOInputHistoryEntryPB(const CSGOInputHistoryEntryPB& from)
  ...
  ::memcpy(&_impl_.buttonstate_, &from._impl_.buttonstate_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.target_ent_index_) -
    reinterpret_cast<char*>(&_impl_.buttonstate_)) + sizeof(_impl_.target_ent_index_));
...
// @@protoc_insertion_point(message_clear_start:CSGOInputHistoryEntryPB)
  ...
  if (cached_has_bits & 0x0000fe00u) {
    ::memset(&_impl_.buttonstate_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.frame_number_) -
        reinterpret_cast<char*>(&_impl_.buttonstate_)) + sizeof(_impl_.frame_number_));
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    ptr = ::_pbi::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      // optional uint64 buttonstate = 1;
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          _Internal::set_has_buttonstate(&has_bits);
          _impl_.buttonstate_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CSGOInputHistoryEntryPB::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000200u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(1, this->_internal_buttonstate(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:CSGOInputHistoryEntryPB)
  ...
  if (cached_has_bits & 0x0000ff00u) {
    ...
    // optional uint64 buttonstate = 1;
    if (cached_has_bits & 0x00000200u) {
      total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_buttonstate());
    }
...
void CSGOInputHistoryEntryPB::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000ff00u) {
    ...
    if (cached_has_bits & 0x00000200u) {
      _this->_impl_.buttonstate_ = from._impl_.buttonstate_;
    }
    if (cached_has_bits & 0x00000400u) {
