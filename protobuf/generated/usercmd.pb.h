...
enum CBaseUserCmdPB_EPredictionReason : int {
  CBaseUserCmdPB_EPredictionReason_k_eNone = 0,
  CBaseUserCmdPB_EPredictionReason_k_eNormal = 1,
  CBaseUserCmdPB_EPredictionReason_k_eForSubtickFrame = 2
};
bool CBaseUserCmdPB_EPredictionReason_IsValid(int value);
constexpr CBaseUserCmdPB_EPredictionReason CBaseUserCmdPB_EPredictionReason_EPredictionReason_MIN = CBaseUserCmdPB_EPredictionReason_k_eNone;
constexpr CBaseUserCmdPB_EPredictionReason CBaseUserCmdPB_EPredictionReason_EPredictionReason_MAX = CBaseUserCmdPB_EPredictionReason_k_eForSubtickFrame;
constexpr int CBaseUserCmdPB_EPredictionReason_EPredictionReason_ARRAYSIZE = CBaseUserCmdPB_EPredictionReason_EPredictionReason_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* CBaseUserCmdPB_EPredictionReason_descriptor();
template<typename T>
inline const std::string& CBaseUserCmdPB_EPredictionReason_Name(T enum_t_value) {
  static_assert(::std::is_same<T, CBaseUserCmdPB_EPredictionReason>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function CBaseUserCmdPB_EPredictionReason_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    CBaseUserCmdPB_EPredictionReason_descriptor(), enum_t_value);
}
inline bool CBaseUserCmdPB_EPredictionReason_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, CBaseUserCmdPB_EPredictionReason* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<CBaseUserCmdPB_EPredictionReason>(
    CBaseUserCmdPB_EPredictionReason_descriptor(), name, value);
}
// ===================================================================
...
class CBaseUserCmdPB final :
 ...
 public:
  ...
  typedef CBaseUserCmdPB_EPredictionReason EPredictionReason;
  static constexpr EPredictionReason k_eNone =
    CBaseUserCmdPB_EPredictionReason_k_eNone;
  static constexpr EPredictionReason k_eNormal =
    CBaseUserCmdPB_EPredictionReason_k_eNormal;
  static constexpr EPredictionReason k_eForSubtickFrame =
    CBaseUserCmdPB_EPredictionReason_k_eForSubtickFrame;
  static inline bool EPredictionReason_IsValid(int value) {
    return CBaseUserCmdPB_EPredictionReason_IsValid(value);
  }
  static constexpr EPredictionReason EPredictionReason_MIN =
    CBaseUserCmdPB_EPredictionReason_EPredictionReason_MIN;
  static constexpr EPredictionReason EPredictionReason_MAX =
    CBaseUserCmdPB_EPredictionReason_EPredictionReason_MAX;
  static constexpr int EPredictionReason_ARRAYSIZE =
    CBaseUserCmdPB_EPredictionReason_EPredictionReason_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  EPredictionReason_descriptor() {
    return CBaseUserCmdPB_EPredictionReason_descriptor();
  }
  template<typename T>
  static inline const std::string& EPredictionReason_Name(T enum_t_value) {
    static_assert(::std::is_same<T, EPredictionReason>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function EPredictionReason_Name.");
    return CBaseUserCmdPB_EPredictionReason_Name(enum_t_value);
  }
  static inline bool EPredictionReason_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      EPredictionReason* value) {
    return CBaseUserCmdPB_EPredictionReason_Parse(name, value);
  }
  ...
  enum : int {
    ...
    kLastPredictionReasonFieldNumber = 22,
    kNextPredictionReasonFieldNumber = 23,
  ...
  bool has_last_prediction_reason() const;
  private:
  bool _internal_has_last_prediction_reason() const;
  public:
  void clear_last_prediction_reason();
  ::CBaseUserCmdPB_EPredictionReason last_prediction_reason() const;
  void set_last_prediction_reason(::CBaseUserCmdPB_EPredictionReason value);
  private:
  ::CBaseUserCmdPB_EPredictionReason _internal_last_prediction_reason() const;
  void _internal_set_last_prediction_reason(::CBaseUserCmdPB_EPredictionReason value);
  public:

  // optional .CBaseUserCmdPB.EPredictionReason next_prediction_reason = 23 [default = k_eNone];
  bool has_next_prediction_reason() const;
  private:
  bool _internal_has_next_prediction_reason() const;
  public:
  void clear_next_prediction_reason();
  ::CBaseUserCmdPB_EPredictionReason next_prediction_reason() const;
  void set_next_prediction_reason(::CBaseUserCmdPB_EPredictionReason value);
  private:
  ::CBaseUserCmdPB_EPredictionReason _internal_next_prediction_reason() const;
  void _internal_set_next_prediction_reason(::CBaseUserCmdPB_EPredictionReason value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    int32_t cmd_flags_;
    int last_prediction_reason_;
    int next_prediction_reason_;
...
// optional .CBaseUserCmdPB.EPredictionReason last_prediction_reason = 22 [default = k_eNone];
inline bool CBaseUserCmdPB::_internal_has_last_prediction_reason() const {
  bool value = (_impl_._has_bits_[0] & 0x00010000u) != 0;
  return value;
}
inline bool CBaseUserCmdPB::has_last_prediction_reason() const {
  return _internal_has_last_prediction_reason();
}
inline void CBaseUserCmdPB::clear_last_prediction_reason() {
  _impl_.last_prediction_reason_ = 0;
  _impl_._has_bits_[0] &= ~0x00010000u;
}
inline ::CBaseUserCmdPB_EPredictionReason CBaseUserCmdPB::_internal_last_prediction_reason() const {
  return static_cast< ::CBaseUserCmdPB_EPredictionReason >(_impl_.last_prediction_reason_);
}
inline ::CBaseUserCmdPB_EPredictionReason CBaseUserCmdPB::last_prediction_reason() const {
  // @@protoc_insertion_point(field_get:CBaseUserCmdPB.last_prediction_reason)
  return _internal_last_prediction_reason();
}
inline void CBaseUserCmdPB::_internal_set_last_prediction_reason(::CBaseUserCmdPB_EPredictionReason value) {
  assert(::CBaseUserCmdPB_EPredictionReason_IsValid(value));
  _impl_._has_bits_[0] |= 0x00010000u;
  _impl_.last_prediction_reason_ = value;
}
inline void CBaseUserCmdPB::set_last_prediction_reason(::CBaseUserCmdPB_EPredictionReason value) {
  _internal_set_last_prediction_reason(value);
  // @@protoc_insertion_point(field_set:CBaseUserCmdPB.last_prediction_reason)
}

// optional .CBaseUserCmdPB.EPredictionReason next_prediction_reason = 23 [default = k_eNone];
inline bool CBaseUserCmdPB::_internal_has_next_prediction_reason() const {
  bool value = (_impl_._has_bits_[0] & 0x00020000u) != 0;
  return value;
}
inline bool CBaseUserCmdPB::has_next_prediction_reason() const {
  return _internal_has_next_prediction_reason();
}
inline void CBaseUserCmdPB::clear_next_prediction_reason() {
  _impl_.next_prediction_reason_ = 0;
  _impl_._has_bits_[0] &= ~0x00020000u;
}
inline ::CBaseUserCmdPB_EPredictionReason CBaseUserCmdPB::_internal_next_prediction_reason() const {
  return static_cast< ::CBaseUserCmdPB_EPredictionReason >(_impl_.next_prediction_reason_);
}
inline ::CBaseUserCmdPB_EPredictionReason CBaseUserCmdPB::next_prediction_reason() const {
  // @@protoc_insertion_point(field_get:CBaseUserCmdPB.next_prediction_reason)
  return _internal_next_prediction_reason();
}
inline void CBaseUserCmdPB::_internal_set_next_prediction_reason(::CBaseUserCmdPB_EPredictionReason value) {
  assert(::CBaseUserCmdPB_EPredictionReason_IsValid(value));
  _impl_._has_bits_[0] |= 0x00020000u;
  _impl_.next_prediction_reason_ = value;
}
inline void CBaseUserCmdPB::set_next_prediction_reason(::CBaseUserCmdPB_EPredictionReason value) {
  _internal_set_next_prediction_reason(value);
  // @@protoc_insertion_point(field_set:CBaseUserCmdPB.next_prediction_reason)
}
...
template <> struct is_proto_enum< ::CBaseUserCmdPB_EPredictionReason> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::CBaseUserCmdPB_EPredictionReason>() {
  return ::CBaseUserCmdPB_EPredictionReason_descriptor();
}
