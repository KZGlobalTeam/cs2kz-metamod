...
class CSGOInputHistoryEntryPB final :
 ...
 public:
  ...
  bool has_buttonstate() const;
  private:
  bool _internal_has_buttonstate() const;
  public:
  void clear_buttonstate();
  uint64_t buttonstate() const;
  void set_buttonstate(uint64_t value);
  private:
  uint64_t _internal_buttonstate() const;
  void _internal_set_buttonstate(uint64_t value);
  public:
...
// optional uint64 buttonstate = 1;
inline bool CSGOInputHistoryEntryPB::_internal_has_buttonstate() const {
  bool value = (_impl_._has_bits_[0] & 0x00000200u) != 0;
  return value;
}
inline bool CSGOInputHistoryEntryPB::has_buttonstate() const {
  return _internal_has_buttonstate();
}
inline void CSGOInputHistoryEntryPB::clear_buttonstate() {
  _impl_.buttonstate_ = uint64_t{0u};
  _impl_._has_bits_[0] &= ~0x00000200u;
}
inline uint64_t CSGOInputHistoryEntryPB::_internal_buttonstate() const {
  return _impl_.buttonstate_;
}
inline uint64_t CSGOInputHistoryEntryPB::buttonstate() const {
  // @@protoc_insertion_point(field_get:CSGOInputHistoryEntryPB.buttonstate)
  return _internal_buttonstate();
}
inline void CSGOInputHistoryEntryPB::_internal_set_buttonstate(uint64_t value) {
  _impl_._has_bits_[0] |= 0x00000200u;
  _impl_.buttonstate_ = value;
}
inline void CSGOInputHistoryEntryPB::set_buttonstate(uint64_t value) {
  _internal_set_buttonstate(value);
  // @@protoc_insertion_point(field_set:CSGOInputHistoryEntryPB.buttonstate)
}
